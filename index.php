...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">Kost<span class="text-primary"> Rajabasa</span></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-4">
                    ...
                    <p class="lead">Testimoni dari para penghuni Kost Putri Rajabasa</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 mb-4">d
                    <div class="testimonial-item">
                        ...
                        <p class="mb-0">"Sudah 2 tahun tinggal di Kost Putri Rajabasa dan sangat nyaman. Lokasinya dekat kampus, Wi-Fi cepat, dan ibu kostnya sangat baik. Seperti tinggal di rumah sendiri!"</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="testimonial-item">
                        ...
                        <p class="mb-0">"Yang saya suka dari Kost Putri Rajabasa adalah kebersihannya terjaga dan lingkungan yang tenang sehingga nyaman untuk istirahat setelah bekerja. Akses ke transportasi umum juga mudah."</p>
                        <div class="mt-2 text-warning">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                        ...
                        <h5 class="card-title mb-4">Informasi Kontak</h5>
                            <div class="d-flex mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Perumahan Polri Hajimena, Jalan Perumahan Polri Hajimena Blok D1 No. 5, Hajimena, Natar</p>
                                </div>
                            </div>
                            <div class="d-flex mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">+62 882-7647-7014</p>
                                </div>
                            </div>
                            <div class="d-flex mb-3">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    ...
                    <p class="lead mb-0">Khusus yang ambil paket 1 tahun, GRATIS 1 bulan pembayaran! Tinggal lebih lama, bayar lebih hemat.</p>
                </div>
    ...
    <a href="https://wa.me/6288276477014" class="position-fixed bottom-0 end-0 mb-4 me-4 btn btn-success rounded-circle p-3" style="z-index: 999;">
